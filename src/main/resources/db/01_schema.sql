...
CREATE TABLE test_sheets (
    ...
    pregnancy_week          SMALLINT        NOT NULL COMMENT '검사 시점 주수 스냅샷',
    ...
    summary_for_mom         TEXT            NULL,
    summary_for_doctor      TEXT            NULL,
...
CREATE TABLE test_results (
    ...
    user_id                 BIGINT          NOT NULL,
    test_date               DATE            NOT NULL,
    pregnancy_week          SMALLINT        NOT NULL,
...
CREATE TABLE appointments (
    ...
    pregnancy_week          SMALLINT        NOT NULL COMMENT 'visit_at 기준 스냅샷',
